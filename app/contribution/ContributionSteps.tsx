...
import { CheckCircle, Loader2, LockKeyhole, BlocksIcon, Server, Award, XCircle } from "lucide-react"
...
export function ContributionSteps({ currentStep, completedSteps, hasError = false }: ContributionStepsProps) {
        ...
        return (
          <div key={step.id} className="flex mb-4 last:mb-0">
            ...
            <div className="mr-4 flex flex-col items-center">
              ...
              {i < contributionSteps.length - 1 && <div className="w-0.5 h-full bg-gray-200 my-1"></div>}
            </div>
            {/* Step content */}
