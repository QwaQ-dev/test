      ...
      <Card className="w-full shadow-lg">
        ...
        <CardContent>
          ...
          <p className="text-sm text-gray-500 mt-2">
            Please try signing out and back in again. If the problem persists, please contact support.
          </p>
        </CardContent>
      </Card>
    )
      ...
      <Card className="w-full">
        <CardHeader className="flex flex-row items-center gap-4">
          <Avatar className="h-16 w-16 border">
            <AvatarImage src={userInfo?.picture || "/placeholder.svg"} alt={userInfo?.name} />
          ...
          <div>
            ...
            <div className="space-y-1 text-sm">
              <div className="flex justify-between">
                <span>Google ID:</span>
                <span className="font-mono text-xs truncate max-w-[200px]">{userInfo?.id}</span>
              </div>
              <div className="flex justify-between">
                <span>Locale:</span>
                <span className="font-medium">{userInfo?.locale || "Not available"}</span>
              </div>
            </div>
          </div>
        </CardContent>
